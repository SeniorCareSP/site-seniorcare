...
function Empresa() {
    return (
        <div id="section2" className={Style["empresa"]}>
            ...
            <div className={Style["descricao"]}>
                <p className={Style["fonte"]}> O compromisso da Senior Care é <spam>atender</spam> às crescentes <spam>necessidades</spam> de uma população idosa, 
