                ...
                Denuncia
                    ...
                    <Stack direction={"column"} marginRight="26vw" marginLeft="4vh" >
                     <Typography variant="body2">Tags:</Typography>
                        ...
                        <Typography variant="body2" sx={{backgroundColor:"#077DB0", borderRadius: "0.6vh",
                        justifyContent: "center", display: "flex", paddingTop:"0.7vh",  width:"5.9vw", height:"4vh", color: "#ffff", fontSize:"2.3vh" }}>Abuso</Typography>

                     <Typography variant="body2" sx={{backgroundColor:"#077DB0", borderRadius: "0.6vh",
                        justifyContent: "center", display: "flex", paddingTop:"0.7vh",  width:"5.9vw", height:"4vh", color: "#ffff", fontSize:"2.3vh" }}>Mal trato</Typography>

                     <Typography variant="body2" sx={{backgroundColor:"#077DB0", borderRadius: "0.6vh",
                    justifyContent: "center", display: "flex", paddingTop:"0.7vh",  width:"5.9vw", height:"4vh", color: "#ffff", fontSize:"2.3vh" }}>Mal uso</Typography>  
                 </Stack>
                    </Stack>
                    </Stack>
